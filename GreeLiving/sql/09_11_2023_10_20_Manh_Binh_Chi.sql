...
VALUES
    ...
    (732, 'Emily', 'Johnson', '555-234-2002', 'emilyjohnson@example.com'),
...
VALUES 
    (74651, 8521, 74791, 1, '2023-11-01', 'Pending', 'Tristan', 'Golby', 'tgolbyk@cocolog-nifty.com', '217-288-4755', 'Web Developer', '$60,000', 'Immediate', 'ABC Corp', NULL, 'Phone', 'I am excited about the opportunity to work as a Web Developer, bringing creative designs to life and enhancing user experiences.'),
    (74652, 8510, 74792, 2, '2023-10-25', 'Pending', 'Zorina', 'Robilliard', 'zrobilliard9@booking.com', 'NA', 'HR Coordinator', '$55,000', '2 weeks', 'XYZ Corp', NULL, 'Email', 'I have a strong background in human resources and am eager to contribute to an organizations success through effective HR strategies.'),
    (74653, 8535, 74794, 3, '2023-11-10', 'Pending', 'Katine', 'Casseldine', 'kcasseldiney@unicef.org', '290-466-7995', 'Digital Marketing Manager', '$70,000', '1 month', 'LMN Corp', NULL, 'Phone', 'As a seasoned digital marketer, Im enthusiastic about leveraging innovative strategies to drive impactful marketing campaigns.'),
    (74654, 8514, 74795, 4, '2023-11-05', 'Pending', 'Clarke', 'Burkett', 'cburkettd@liveinternet.ru', '472-801-5384', 'Content Writer', '$45,000', 'Immediate', 'PQR Corp', NULL, 'Email', 'My passion for writing combined with my diverse skill set makes me an ideal candidate for the Content Writer role.'),
    (74655, 853, 74797, 5, '2023-10-30', 'Pending', 'Romain', 'Goddert.sf', 'rgoddertsf2@nyu.edu', 'NA', 'Civil Engineer', '$80,000', '3 weeks', 'IJK Corp', NULL, 'Phone', 'I bring a wealth of experience in civil engineering and am eager to apply my skills to complex infrastructure projects.'),
    (74656, 8528, 74798, 6, '2023-11-08', 'Pending', 'Rhea', 'Dukesbury', 'rdukesburyr@alibaba.com', '942-975-6483', 'Research Scientist', '$90,000', '1 month', 'EFG Corp', NULL, 'Email', 'With a strong background in scientific research, I am excited about contributing to groundbreaking projects as a Research Scientist.'),
    (74657, 859, 747910, 7, '2023-11-15', 'Pending', 'Flemming', 'Camis', 'fcamis8@tuttocitta.it', '292-983-1110', 'Financial Advisor', '$75,000', 'Immediate', 'HIJ Corp', NULL, 'Phone', 'I am passionate about assisting clients in achieving their financial goals and making informed investment decisions.'),
    (74658, 8520, 747912, 8, '2023-11-12', 'Pending', 'Wynne', 'Mariolle', 'wmariollej@oakley.com', '319-245-6802', 'Data Analyst', '$65,000', '2 weeks', 'KLM Corp', NULL, 'Email', 'As a skilled data analyst, I am eager to utilize my analytical skills to derive valuable insights and drive informed decision-making.'),
    (74659, 8517, 747913, 9, '2023-11-18', 'Pending', 'Marnia', 'Topham', 'mtophamg@amazon.co.jp', '716-913-3474', 'Mechanical Engineer', '$85,000', '1 month', 'NOP Corp', NULL, 'Phone', 'Im enthusiastic about employing my mechanical engineering expertise to innovate and develop cutting-edge technologies.'),
    (746510, 8522, 747915, 10, '2023-11-22', 'Pending', 'Kennan', 'Danilovitch', 'kdanilovitchm@arstechnica.com', '636-868-5689', 'Software Developer', '$70,000', '3 weeks', 'QRS Corp', NULL, 'Email', 'With a strong background in software development, Im excited about contributing to high-impact projects and delivering innovative solutions.'),
    (746511, 8526, 747917, 1, '2023-11-01', 'Pending', 'Costanza', 'Gocke', 'cgockep@cpanel.net', 'NA', 'Web Developer', '$60,000', 'Immediate', 'UVW Corp', NULL, 'Phone', 'As a dedicated web developer, I aim to create dynamic and user-friendly web applications to enhance user experiences.'),
    (746512, 8534, 747918, 2, '2023-10-25', 'Pending', 'Shirlee', 'Miklem', 'smiklemx@sogou.com', '572-698-7547', 'Marketing Specialist', '$55,000', '2 weeks', 'XYZ Corp', NULL, 'Email', 'With a creative approach, I seek to develop marketing strategies to elevate brand visibility and market penetration.'),
    (746513, 8529, 747920, 3, '2023-11-10', 'Pending', 'Leland', 'Wakerley', 'lwakerleys@free.fr', '259-987-1414', 'Project Manager', '$75,000', '1 month', 'LMN Corp', NULL, 'Phone', 'As a project manager, I strive to oversee complex projects with meticulous planning and efficient execution.'),
    (746514, 8518, 74791, 4, '2023-11-05', 'Pending', 'Kassandra', 'Rhead', 'krheadh@hexun.com', '614-489-2463', 'E-commerce Specialist', '$45,000', 'Immediate', 'PQR Corp', NULL, 'Email', 'With a penchant for e-commerce, I endeavor to manage and optimize online sales platforms for seamless shopping experiences.'),
    (746515, 8523, 74792, 5, '2023-10-30', 'Pending', 'Kennan', 'Danilovitch', 'kdanilovitchm@arstechnica.com', '636-868-5689', 'Architect', '$80,000', '3 weeks', 'IJK Corp', NULL, 'Phone', 'Experienced in architectural designs, I aim to innovate and oversee cutting-edge architectural projects.'),
    (746516, 8515, 74794, 6, '2023-11-08', 'Pending', 'Vally', 'Elegood', 'velegoode@usatoday.com', '370-255-2934', 'Baker', '$50,000', '1 month', 'EFG Corp', NULL, 'Phone', 'Passionate about baking, I endeavor to create delectable baked goods and maintain high production standards.'),
    (746517, 8530, 74795, 7, '2023-11-15', 'Pending', 'Letty', 'Raynor', 'lraynort@fc2.com', '371-136-8888', 'Education Consultant', '$85,000', 'Immediate', 'HIJ Corp', NULL, 'Email', 'Skilled in educational consulting, Im eager to develop effective curriculum and foster learning opportunities.'),
    (746518, 8525, 74798, 8, '2023-11-12', 'Pending', 'Staford', 'McElwee', 'smcelweeo@latimes.com', '261-825-9228', 'Content Writer', '$40,000', '2 weeks', 'KLM Corp', NULL, 'Phone', 'Committed to writing, I aim to create engaging content that resonates with diverse audiences.'),
    (746519, 8512, 747910, 9, '2023-11-18', 'Pending', 'Dennison', 'Glackin', 'dglackinb@hatena.ne.jp', '788-407-3597', 'Customer Service Representative', '$35,000', '1 month', 'NOP Corp', NULL, 'Email', 'With a dedication to customer service, I strive to ensure high levels of customer satisfaction and support.'),
    (746520, 8528, 747910, 10, '2023-11-22', 'Pending', 'Rhea', 'Dukesbury', 'rdukesburyr@alibaba.com', '942-975-6483', 'Curriculum Developer', '$75,000', '3 weeks', 'QRS Corp', NULL, 'Phone', 'As a curriculum developer, I aim to create engaging and innovative educational content to facilitate effective learning experiences.');
...
VALUES 
    (74791, 66831, 'Open', 'Software Engineer', 'Weimann-Zulauf', 'softwarejobs@weimannzulauf.com', '123-456-7890', 'San Francisco, CA', 'Full-time', 'Weimann-Zulauf is seeking a highly skilled Software Engineer to join our team. The ideal candidate should have strong programming skills and experience in software development projects.'),
    (74792, 66832, NULL, 'Marketing Specialist', 'Powlowski, Feeney and Schimmel', 'marketingjobs@powlowskifeeney.com', '987-654-3210', 'New York City, NY', 'Part-time', 'Powlowski, Feeney and Schimmel is looking for a talented Marketing Specialist to develop and execute marketing strategies. Must have a creative approach and strong analytical skills.'),
    (74794, 66833, 'Open', 'Project Manager', 'Gulgowski Inc', 'projectmanager@gulgowski.com', '333-555-7777', 'Los Angeles, CA', 'Full-time', NULL),
    (74795, 66834, 'Closed', 'E-commerce Specialist', 'Collins, Schaden and Goyette', 'ecommercejobs@collinsschaden.com', '444-777-9999', 'Seattle, WA', 'Full-time', 'We are hiring an E-commerce Specialist responsible for managing online sales platforms, developing marketing strategies, and ensuring a seamless online shopping experience.'),
    (74797, 66835, 'Open', 'Architect', 'Considine LLC', 'architectjobs@consinde.com', '222-333-4444', 'Miami, FL', 'Full-time', 'Considine LLC seeks an experienced Architect to design and oversee various architectural projects. Candidates should have a strong portfolio and design skills.'),
    (74798, 66836, NULL, 'Baker', 'Connelly-Zulauf', 'bakerjobs@connellyzulauf.com', '333-666-8888', 'Denver, CO', 'Part-time', 'Connelly-Zulauf is looking for a passionate Baker to join our team. This role involves creating high-quality baked goods and maintaining production standards.'),
    (747910, 66837, 'Open', 'Education Consultant', 'Huel, Zulauf and Stehr', 'educationjobs@huelzulauf.com', '999-000-1111', 'Boston, MA', 'Full-time', NULL),
    (747912, 66838, NULL, 'Data Analyst', 'Weimann-Zulauf', 'datajobs@weimannzulauf.com', '123-456-7890', 'San Francisco, CA', 'Full-time', 'Weimann-Zulauf is looking for a skilled Data Analyst to analyze and interpret complex data sets.'),
    (747913, 66839, 'Closed', 'Content Writer', 'Powlowski, Feeney and Schimmel', 'contentwriter@powlowskifeeney.com', '987-654-3210', 'HaNoi', 'Full-time',NULL),
    (747915, 668310, NULL, 'Customer Service Representative', 'Connelly-Zulauf', 'customerservice@connellyzulauf.com', '333-666-8888', 'Denver, CO', 'Full-time', 'Connelly-Zulauf is looking for a dedicated Customer Service Representative to ensure high levels of customer satisfaction.'),
    (747917, 66831, 'Open', 'Civil Engineer', 'Raynor, Pfannerstill and Hintz', 'engineerjobs@raynorpfa.com', '222-333-4444', 'Miami, FL', 'Full-time', 'Raynor, Pfannerstill and Hintz seeks an experienced Civil Engineer to work on various infrastructure projects.'),
    (747918, 66832, NULL, 'Research Scientist', 'Weissnat Inc', 'research@weissnat.com', '444-777-9999', 'Seattle, WA', 'Full-time', 'Weissnat Inc is seeking a Research Scientist to lead scientific research projects and develop new innovations.'),
    (747920, 66833, 'Open', 'Curriculum Developer', 'Huel, Zulauf and Stehr', 'curriculum@huelzulauf.com', '999-000-1111', 'Boston, MA', 'Full-time', 'Huel, Zulauf and Stehr is looking for a Curriculum Developer to create engaging and effective educational content.');

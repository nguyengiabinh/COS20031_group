...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2023 at 03:49 PM
...
INSERT INTO `user_course` (`user_course_id`, `user_id`, `course_id`) VALUES
(8567, 8526, 671),
(8568, 8526, 672);
...
--
ALTER TABLE `interview`
  MODIFY `interview_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `user_course`
  MODIFY `user_course_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8569;

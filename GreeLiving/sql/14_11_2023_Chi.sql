...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2023 at 08:58 AM
...
(851, 'Janela', 'Brewins', '0000-00-00', '3823 Gale Parkway', 'jbrewins0@answers.com', NULL),
(852, 'Dosi', 'Pollington', '0000-00-00', '208 Lerdahl Plaza', 'dpollington1@umn.edu', NULL),
...
ALTER TABLE `user_tag`
  ...
  ADD KEY `user_tag_ibfk_1` (`user_id`),
  ADD KEY `user_tag_ibfk_2` (`tag_id`);
